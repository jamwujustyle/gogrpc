...
func (x *SumRequest) GetNumOne() int32 {
	if x != nil {
		return x.NumOne
	}
	return 0
...
func (x *SumRequest) GetNumTwo() int32 {
	if x != nil {
		return x.NumTwo
	}
	return 0
...
const file_sum_proto_sum_proto_rawDesc = "" +
	...
	"\n" +
	"SumRequest\x12\x17\n" +
	"\anum_one\x18\x01 \x01(\x05R\x06numOne\x12\x17\n" +
	"\anum_two\x18\x02 \x01(\x05R\x06numTwo\"%\n" +
	"\vSumResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result2=\n" +
	"\x11CalculatorService\x12(\n" +
	"\x03Sum\x12\x0f.sum.SumRequest\x1a\x10.sum.SumResponseB*Z(github.com/jamwujustyle/gogrpc/sum/protob\x06proto3"
